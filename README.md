...
This is just an slightly modified `itemize` environment. This one has a title and no indentation. That's basically it. I use it for… lists. As an example, here is the list of mathematics books I read apart from my degrees.
